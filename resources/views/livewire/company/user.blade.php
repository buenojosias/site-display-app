<div>
    <form wire:submit.prevent="saveAddress">
        <div class="sb-header">
            <h2>Usuário</h2>
            <h5>Cada empresa pode ter um usuário vinculado para fazer o gerenciamento</h5>
        </div>
        <div class="sb-body">
            <x-errors class="mb-4" />
            ...
            @else
                @if (!$users)
                    <div>
                        ...
                        <div class="text-sm">Selecione um usuário existente ou gere uma chave para um novo cadastro
                        </div>
                    </div>
                    <div class="mt-4">
