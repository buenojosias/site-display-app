            ...
            <form wire:submit.prevent="saveLink">
                <div class="sb-body">
                    ...
                    <div class="grid-2">
                        ...
                        <x-inputs.maskable wire:model.defer="whatsapp" mask="['(##) ####-####', '(##) #####-####']" label="WhatsApp"
                        ...
                        <x-input wire:model.defer="site" label="Site" placeholder="https://www.seusite.com" hint="Deve ser completo, incluindo https" />
                    </div>
                </div>
                <div class="sb-footer">
